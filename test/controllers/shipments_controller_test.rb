...
class ShipmentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create shipment" do
    assert_difference('Shipment.count') do
      post shipments_url, params: { shipment: { carrier_id: @shipment.carrier_id, tracking_number: @shipment.tracking_number } }
    end
  ...
  test "should update shipment" do
    patch shipment_url(@shipment), params: { shipment: { carrier_id: @shipment.carrier_id, tracking_number: @shipment.tracking_number } }
