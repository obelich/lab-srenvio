...
class ParcelsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create parcel" do
    assert_difference('Parcel.count') do
      post parcels_url, params: { parcel: { distance_unit: @parcel.distance_unit, height: @parcel.height, length: @parcel.length, mass_unit: @parcel.mass_unit, shipments_id: @parcel.shipments_id, weight: @parcel.weight, width: @parcel.width } }
    end
  ...
  test "should update parcel" do
    patch parcel_url(@parcel), params: { parcel: { distance_unit: @parcel.distance_unit, height: @parcel.height, length: @parcel.length, mass_unit: @parcel.mass_unit, shipments_id: @parcel.shipments_id, weight: @parcel.weight, width: @parcel.width } }
